  ...
  return (
    <Drawer.Root {...props} direction={direction}>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          className={cn(
            "bg-background-dark fixed z-[9999] place-self-center outline-none",
        ...
        >
          ...
          >
            ...
            {!hiddenHandler && (
              <div
                className={cn(
                  "bg-foreground/50 mx-auto h-1.5 w-12 flex-shrink-0 rounded-full",
                  classNames?.handler,
                )}
              />
            )}
            <Drawer.Title
              ...
              className={cn("text-center text-xl font-semibold", classNames?.title, {
                hidden: hiddenTitle,
              })}
            >
              {title}
